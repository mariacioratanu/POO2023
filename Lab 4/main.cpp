...
int main()
{
    ...
    type2.Print();
    cout<<type2.GetElementsCount()<<endl; //number of elements: 6
    cout<<type2.GetElementFromIndex(2)<<endl; //element from index 2: 3
    ...
    type4.Print();
    cout<<type4.GetElementsCount()<<endl; //number of elements: 8
    cout<<type4.GetElementFromIndex(4)<<endl; //element from index 4:-11
}
