...
int main()
{
    ...
    Contact* friend1 = new Friend("John Doe", "1980-01-01", "123456789", "123 Main St"); // Creating a Friend object with specific details
    Contact* friend2 = new Friend("Jane Smith", "1990-05-10", "987654321", "456 Elm St"); // Creating another Friend object with specific details
    Contact* acquaintance1 = new Acquaintance("Alice Johnson", "555555555"); // Creating an Acquaintance object with specific details
    Contact* acquaintance2 = new Acquaintance("David Brown", "777777777");
    Contact* colleague1 = new Colleague("Bob Williams", "999999999", "ABC Company", "789 Oak Ave"); // Creating a Colleague object with specific details
    Contact* colleague2 = new Colleague("Sarah Davis", "111111111", "XYZ Corporation", "321 Maple St");
    ...
    Contact* foundContact = agenda.findContact("Alice Johnson"); // Finding a contact by name
    if (foundContact)
    {
        foundContact->printDetails(); // Printing the details of the found contact
    } else
    {
    ...
    std::cout << "Removing contact: John Doe" << std::endl;
    agenda.removeContact("John Doe"); // Removing a contact from the agenda
